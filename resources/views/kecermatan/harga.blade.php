        ...
        <div class="col-md-4">
            <div class="pricing-card">
                ...
                <ul class="feature-list">
                    ...
                    <li>
                        <span class="feature-check">✓</span>
                        <span>Video Pembelajaran AKADEMIK meliputi: (Wawasan Kebangsaan, Pengetahuan Umum, Tes Penalaran Numerik, B. Inggris) dan PSIKOTEST Secara Singkat, Jelas dan Mudah Dipahami.</span>
                    </li>
                    <li>
                        <span class="feature-check">✓</span>
