...
@section('title', 'Detail Laporan Paket Lengkap')
                        ...
                        <div class="col-lg-12">
                            <div class="siswa-header">
                                <div class="siswa-info">
                                    ...
                                    <p class="text-muted">Total Tes: {{ count($analisis) }} kategori</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="analisis-section">
                                <h4><i class="fa fa-chart-pie"></i> Analisis Detail per Kategori</h4>
                                    ...
                                    <div class="kategori-card">
                                        ...
                                        <div class="kategori-content">
                                            ...
                                            <div class="rekomendasi-section">
                                                <h6><i class="fa fa-lightbulb"></i> Rekomendasi:</h6>
                                                <p class="rekomendasi-text">
                                                    @if($item['selisih_skor'] > 0)
                                                        <span class="text-success">✓ Kategori ini menunjukkan peningkatan yang baik. Pertahankan konsistensi latihan untuk mempertahankan performa.</span>
                                                    @elseif($item['selisih_skor'] < 0)
                                                        <span class="text-danger">⚠ Kategori ini mengalami penurunan. Perbanyak latihan dan fokus pada area yang lemah.</span>
                                                    @else
                                                        <span class="text-warning">→ Kategori ini stagnan. Coba variasi metode belajar untuk meningkatkan performa.</span>
                                                    @endif
                                                </p>
                                            </div>
                                        </div>
